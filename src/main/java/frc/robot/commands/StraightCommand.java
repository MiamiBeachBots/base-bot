...
public class StraightCommand extends CommandBase {
   ...
   *
   * @param subsystem The subsystem used by this command. A function that returns the value of the Y
  ...
  @Override
  public void execute() {
    System.out.println("gyrodrive GAYYYYYYYYYYYY");
    m_driveSubsystem.driveStraight(m_gyroSubsystem.getYaw(), m_gyroSubsystem.getAccumYaw(), (m_joy_x.getAsDouble() + m_joy_y.getAsDouble()) /2);
  }
